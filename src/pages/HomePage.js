  ...
  return (
    <Layout>
        ...
        >
          ...
          >
            <h1 className="display-5 fw-bold lh-1 mb-3 ">
              Meals and Transportation Services. Together We Can Deliver
            </h1>
            <div className="hr-purple"></div>
            <p>
              Our aspirations and guiding principles are determined by the
      ...
      <div className="home-content">
        <div className="container col-xxl-8 px-4 py-5" bis_skin_checked="1">
          <div
            className="row flex-lg-row-reverse align-items-center g-5 py-5 animate__animated animate__fadeInDown"
            bis_skin_checked="1"
          >
            <div className="col-lg-6" bis_skin_checked="1">
              <h1 className="display-5 fw-bold lh-1 mb-3">Who We Are</h1>
              <p>
                All of our clients at Meals on Wheels are working toward
                becoming independent. We deliver hot and frozen meals, as well
                as provide door-to-door transportation.
              </p>
              <div className="hr-yellow"></div>
              <h3 className="fw-bold lh-1 mb-3 purple-text">Our Vision </h3>
              <p>
                A place where everyone has a path to independence and wellness.
              </p>
      ...
      <div className="wave-content text-white">
        <div className="container col-xxl-8 px-4 py-5" bis_skin_checked="1">
          <div
            className="row flex-lg-row-reverse align-items-center g-5 py-5 animate__animated animate__fadeInLeftBig"
            bis_skin_checked="1"
          >
            <div className="col-10 col-sm-8 col-lg-6" bis_skin_checked="1">
              <motion.img
            ...
            <div className="col-lg-6" bis_skin_checked="1">
              ...
              <ul>
                <li>
                  We hold our volunteers in the highest regard; they are the
                  foundation of our work.
                </li>
                <li>
                  Through partnerships, diversity, and inclusion, we respect our
                  community.
                </li>
                <li>We welcome innovation and organizational change.</li>
                <li>
                  Our company practices fiscal, social, and environmental
                  responsibility.
                </li>
                <li>
                  We consistently offer services and programs of the highest
                  caliber.
                </li>
              </ul>
            </div>
        ...
        <div className="container col-xxl-8 px-4 py-5" bis_skin_checked="1">
          <div
            className="row flex-lg-row-reverse align-items-center g-5 py-5 animate__animated animate__fadeInRightBig"
            bis_skin_checked="1"
          >
            <div className="col-10 col-sm-8 col-lg-6" bis_skin_checked="1">
              <Row>
            ...
            <div className="col-lg-6" bis_skin_checked="1">
              ...
              <p>
                Providing assistance to seniors (55+) and adults with
                disabilities who require nutritional support. Long-term
                assistance or temporary assistance (caregiver relief, recovery,
                or seasonal).{" "}
              </p>
            </div>
          </div>
          ...
          <div className="card pb-5 mb-5 text-white animate__animated animate__slideInUp">
            ...
            <div className="text-center">
              <h1 className="text-white">
                Keep Up With Service News and Events
              </h1>
