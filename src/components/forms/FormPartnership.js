      ...
      <div className="col-xxl-8 px-4 py-5">
        ...
        >
          ...
          <div className="col-lg-6 text-center" bis_skin_checked="1">
            <Form onSubmit={handleSubmit} className="px-3 text-white text-center">
              <Form.Group className="mb-3 mx-3" controlId="name">
                <Form.Label>Company Name</Form.Label>
                <Form.Control type="text" onChange={(e) => setName(e.target.value)} value={name} placeholder="" required />
              </Form.Group>
              <Form.Group className="mb-3 mx-3" controlId="email">
                <Form.Label>Company Email</Form.Label>
                <Form.Control type="email" onChange={(e) => setEmail(e.target.value)} value={email} placeholder="" required />
              </Form.Group>
              <Form.Group className="mb-3 mx-3" controlId="address">
                <Form.Label>Company Address</Form.Label>
                <Form.Control type="text" onChange={(e) => setAddress(e.target.value)} value={address} placeholder="" required />
              </Form.Group>
              <Form.Group className="mb-3 mx-3" controlId="password">
                <Form.Label>Password</Form.Label>
                <Form.Control type="password" onChange={(e) => setPassword(e.target.value)} value={password} placeholder="" required />
              </Form.Group>
              <Form.Group className="mb-3 mx-3" controlId="file">
                  <Form.Label>Image Upload</Form.Label>
                  <Form.Control type="file" onChange={(e) => setFile(e.target.files[0])} placeholder="" required />
              </Form.Group>
