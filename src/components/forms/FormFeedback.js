        ...
        <div className="container col-12 col-sm-3 col-lg-6 d-flex justify-content-center">
            <div className="card m-5 w-75">
                <Form className="p-3">
                    ...
                    <FloatingLabel controlId="floatingSelect" label="Feedback on Meals" className="mx-3 mb-3">
                    ...
                    <FloatingLabel controlId="floatingTextarea2" label="Feedback" className="mb-3 mx-3">
                        <Form.Control
                            as="textarea"
                    ...
                    <div className="text-center mb-2mx-3 pt-3">
                        <Button className="button fw-bold" size="lg">Submit</Button>
                    </div>
                </Form>
            </div>
        </div>
